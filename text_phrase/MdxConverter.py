...
# pip install openpyxl #openpyxl - A Python library to read/write Excel 2010 xlsx/xlsm files
pip install pdfkit
pip install imgkit
pip install lxml
pip install chardet
...
""" 
pyinstaller MdxConverter.py --onefile --exclude-module pandas --exclude-module numpy --exclude-module PyQt4 --exclude-module tkinter --exclude-module PyQt5 --exclude-module PySide2
"""
...
python MdxConverter.py --type html O8C.mdx /Users/apple/Downloads/Oxford_mdict/O8C.mdx
pip install mdict-utils
mdict -m ~/Downloads/Oxford_mdict/O8C.mdx --convert-chtml 
